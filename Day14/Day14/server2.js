...
const collectionName = "Stack"; // Replace with your collection name
const dbURI = `mongodb+srv://sarubanv2023ece:oLOvKxqbu67fLcV8@cluster0.bxdn0mm.mongodb.net/${databaseName}?retryWrites=true&w=majority`;
